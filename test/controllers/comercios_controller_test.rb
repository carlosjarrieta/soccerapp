...
class ComerciosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comercio" do
    assert_difference('Comercio.count') do
      post comercios_url, params: { comercio: { admin_id: @comercio.admin_id, ciudad_id: @comercio.ciudad_id, direccion: @comercio.direccion, latitud: @comercio.latitud, longitud: @comercio.longitud, nombre: @comercio.nombre, telefono: @comercio.telefono } }
    end
  ...
  test "should update comercio" do
    patch comercio_url(@comercio), params: { comercio: { admin_id: @comercio.admin_id, ciudad_id: @comercio.ciudad_id, direccion: @comercio.direccion, latitud: @comercio.latitud, longitud: @comercio.longitud, nombre: @comercio.nombre, telefono: @comercio.telefono } }
